...
//           _T("ImGui Tool"),   NULL};
//     ::RegisterClassEx(&wc);
//     hwnd = ::CreateWindow(wc.lpszClassName, _T("ImGui Tool"), WS_OVERLAPPEDWINDOW, 100, 100, 1920 / 2, 1080 / 2,
//     NULL,
...
//     // 创建窗口
//     hwnd = ::CreateWindow(wc.lpszClassName, _T("ImGui Tool"), WS_OVERLAPPEDWINDOW, screenWidth / 4, screenWidth / 4,
//                           screenWidth / 2, screenHeight / 2, NULL, NULL, wc.hInstance, NULL);
//     if (!hwnd) {
//         std::cout << "hwnd Creation failure " << std::endl;
//         return;
//     }
//     IMGUI_CHECKVERSION();
//     ImGui::CreateContext();
