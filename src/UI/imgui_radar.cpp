...
//         uv0 = {0.0f + (newZoomFactor * 0.5f), 0.0f + (newZoomFactor * 0.5f)};
//         uv1 = {1.0f - (newZoomFactor * 0.5f), 1.0f - (newZoomFactor * 0.5f)};
//         imageWidth = 1.0f + (uv1.x - uv0.x) * 2.0f;
//         imageHeight = 1.0f + (uv1.y - uv0.y) * 2.0f;
//         ImVec2 newImageSize = {zoomedSize.x * imageWidth, zoomedSize.y * imageHeight};
...
//         gameData.Radar.ScreenCenter = {deltaOffset.x, deltaOffset.y};
//         gameData.Radar.ZoomFactor = newZoomFactor;
//         if (io.MousePos.x != gameData.Radar.CenterPoint.x || io.MousePos.y != gameData.Radar.CenterPoint.y) {
//             ImVec2 MousePosOFFset = io.MousePos - gameData.Radar.CenterPoint;
//             float ux = MousePosOFFset.x / newImageSize.x;
//             float uy = MousePosOFFset.y / newImageSize.y;
//             gameData.Radar.ScreenCenter.X += ux;
//             gameData.Radar.ScreenCenter.Y += uy;
//         }
//         gameData.Radar.CenterPoint = MousePos;
//     }
