...
std::vector<DWORD_PTR> GetEntitys() {
    ...
    for (int i = 0; i < gameData.ActorCount; i++) {
        entityAddresses.push_back(gameData.Actor + (i * 0x8));
    }
...
std::vector<std::string> GetPlayerNames(std::vector<DWORD_PTR> entitys) {
    ...
    characterNames =
        VmmCore::ReadScatterValues<std::vector<DWORD_PTR>>(VmmCore::GetScatterHandle(2), characterNameAddresses);
...
std::vector<float> GetPlayerGroggyHealths(std::vector<DWORD_PTR> entitys) {
    ...
    playerGroggyHealths =
        VmmCore::ReadScatterValues<std::vector<float>>(VmmCore::GetScatterHandle(2), playerGroggyHealthAddresses);
...
std::vector<DWORD_PTR> GetEntityRootComponents(std::vector<DWORD_PTR> entitys) {
    ...
    rootComponents =
        VmmCore::ReadScatterValues<std::vector<DWORD_PTR>>(VmmCore::GetScatterHandle(0), rootComponentAddresses);
...
std::vector<DWORD_PTR> GetPlayerMeshComponents(std::vector<DWORD_PTR> entitys) {
    ...
    playerMeshComponents =
        VmmCore::ReadScatterValues<std::vector<DWORD_PTR>>(VmmCore::GetScatterHandle(0), playerMeshComponentAddresses);
...
std::vector<FTransform> GetPlayerHeadBones(std::vector<DWORD_PTR> ptr) {
    ...
    relusts = VmmCore::ReadScatterValues<std::vector<FTransform>>(addresses);
